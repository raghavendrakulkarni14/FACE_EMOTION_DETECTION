...
faceCascade = cv2.CascadeClassifier('C:/Users/Dell/Desktop/Deeplearning_Project/haarcascade_frontalface_default.xml')
model =load_model('C:/Users/Dell/Desktop/Capstone 5 Emotion Detection/emotion detection model.h5')
...
def main():
    ...
    activities = ['Live video stream emotion detection','upload photo','About']
    ...
    if choice == "Live video stream emotion detection":
        ...
        st.subheader("Realtime Face Emotion Detection Created By Raghavendra & Suhas Almabetter Data Science Trainee Using OpenCV, Transfer Learning MobileNet Model And Streamlit")
